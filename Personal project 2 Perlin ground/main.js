...
function setup() {
    ...
    function makeFace(x,y,z,size, arr){
        ...
        faceColor = calculateColor(newY, size);
    ...
    mat4.translate(viewMatrix, viewMatrix, [-200, -100, -500]); // Move the camera back along the z-axis
    mat4.rotateX(viewMatrix, viewMatrix, Math.PI / 7); // Rotate the camera to look downwards with a slight tilt
